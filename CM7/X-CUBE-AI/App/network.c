...
#define AI_NETWORK_MODEL_SIGNATURE     "f4bd3e60e844a06b23e4605ac6f43c5c"
...
#define AI_TOOLS_DATE_TIME   "Sun Aug 13 07:35:00 2023"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    nl_0_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    nl_0_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    pool_1_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    pool_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    
    conv2d_2_output_array.data = AI_PTR(g_network_activations_map[0] + 24768);
    conv2d_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24768);
    
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 55744);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 55744);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_2_weights_array.data = AI_PTR(g_network_weights_map[0] + 128);
    conv2d_2_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 128);
    
    conv2d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 73856);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 73856);
    
    gemm_5_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_weights_array.data = AI_PTR(g_network_weights_map[0] + 74112);
    gemm_5_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 74112);
    
    gemm_5_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_5_bias_array.data = AI_PTR(g_network_weights_map[0] + 138112);
    gemm_5_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 138112);
    
    conv2d_0_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 138152);
    conv2d_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 138152);
